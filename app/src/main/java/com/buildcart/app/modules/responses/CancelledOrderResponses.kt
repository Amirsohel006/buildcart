...
data class CancelledOrderResponses(
    @SerializedName("success"  ) var success  : String?             = null,
    @SerializedName("message"  ) var message  : String?             = null,
    @SerializedName("response" ) var response : ArrayList<CancelledResponse> = arrayListOf()
)



data class CancelledCategories (
...
data class CancelledProductGalleries (
...
data class CancelledProduct (

    @SerializedName("product_id"              ) var productId             : String?                     = null,
    @SerializedName("name"                    ) var name                  : String?                     = null,
    @SerializedName("categories"              ) var categories            : ArrayList<CancelledCategories>       = arrayListOf(),
    @SerializedName("favourate"               ) var favourate             : ArrayList<CancelledFavourate>        = arrayListOf(),
    ...
    @SerializedName("product_galleries"       ) var productGalleries      : ArrayList<CancelledProductGalleries> = arrayListOf(),
...
data class CancelledResponse (
    ...
    @SerializedName("product"           ) var product         : CancelledProduct? = CancelledProduct(),

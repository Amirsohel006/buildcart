...
class SpinnerGroupThirtyTwoAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroupThirtyTwoModel>
) : ArrayAdapter<SpinnerGroupThirtyTwoModel>(mContext, layoutResource, allItems) {

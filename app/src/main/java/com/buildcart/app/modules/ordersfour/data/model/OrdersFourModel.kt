package com.buildcart.app.modules.ordersfour.`data`.model

import com.buildcart.app.R
import com.buildcart.app.appcomponents.di.MyApp
import kotlin.String

data class OrdersFourModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtGroupSeventyFour: String? = MyApp.getInstance().resources.getString(R.string.lbl_pincode)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtGroupSeventyThree: String? = MyApp.getInstance().resources.getString(R.string.lbl_city)
  ,
  /**
   * TODO Replace with dynamic value
   */

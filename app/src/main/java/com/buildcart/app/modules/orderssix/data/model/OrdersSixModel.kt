package com.buildcart.app.modules.orderssix.`data`.model

import com.buildcart.app.R
import com.buildcart.app.appcomponents.di.MyApp
import kotlin.String

data class OrdersSixModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtGroupSeventyNine: String? = MyApp.getInstance().resources.getString(R.string.lbl_pincode)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtGroupSeventyEight: String? = MyApp.getInstance().resources.getString(R.string.lbl_city)
  ,
  /**
   * TODO Replace with dynamic value
   */

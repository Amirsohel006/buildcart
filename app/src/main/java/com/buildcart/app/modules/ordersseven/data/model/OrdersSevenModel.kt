package com.buildcart.app.modules.ordersseven.`data`.model

import com.buildcart.app.R
import com.buildcart.app.appcomponents.di.MyApp
import kotlin.String

data class OrdersSevenModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtGetHelp: String? = MyApp.getInstance().resources.getString(R.string.lbl_get_help)

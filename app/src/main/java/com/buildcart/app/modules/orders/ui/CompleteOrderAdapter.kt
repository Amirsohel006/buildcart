...
class CompleteOrderAdapter (
    var list: List<CompleteResponse>
) : RecyclerView.Adapter<CompleteOrderAdapter.RowCompleteOrderVH>()  {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): CompleteOrderAdapter.RowCompleteOrderVH {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.row_completed_orders, parent, false)
    ...
    inner class RowCompleteOrderVH(
        ...
        fun bindView(postModel: CompleteResponse) {

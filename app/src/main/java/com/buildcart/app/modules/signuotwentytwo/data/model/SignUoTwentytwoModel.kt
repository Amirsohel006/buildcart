package com.buildcart.app.modules.signuotwentytwo.`data`.model

import com.buildcart.app.R
import com.buildcart.app.appcomponents.di.MyApp
import kotlin.String

data class SignUoTwentytwoModel(
  /**
   * TODO Replace with dynamic value
   */
  var txtConfirmOrder: String? = MyApp.getInstance().resources.getString(R.string.lbl_confirm_order)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var txtProducts: String? = MyApp.getInstance().resources.getString(R.string.lbl_products2)
  ,
  /**
   * TODO Replace with dynamic value
   */
